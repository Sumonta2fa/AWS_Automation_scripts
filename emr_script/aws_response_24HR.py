...
#	t81 = Timeline['ReadyDateTime']
 ...
 #       t8 = unicode(t81).partition('.')[0]	
     ...
     #   f = open('/home/ashish/script/data24.csv', "a+")
...
msg['Subject'] = 'EMR cluster details '+datestr
msg.attach(MIMEText("EMR cluster details"))
datestring = datetime.strftime(datetime.now(), '%Y-%m-%d')
file = 'data_'+datestring+'.csv'
...
try:
   ...
   smtpObj.sendmail('localhost', 'engg_ops@xxxx.com', msg.as_string())
